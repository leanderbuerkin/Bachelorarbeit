...
\begin{document}
    ...
    \input{chapters/0_0-Titelseite.tex}
    ...
    \input{chapters/0_1-Erklaerung.tex}
    \input{chapters/0_2-Zusammenfassung.tex}
    \input{chapters/0_3-Zitat.tex}
    \tableofcontents
    \listoffigures
    \listoftables
    \listofalgorithms
    ...
    \input{chapters/2-Grundlagen und Stand der Forschung.tex}
    \input{chapters/3-Durchführung.tex}
    \input{chapters/4-Ergebnisse.tex}
    \input{chapters/5-Diskussion.tex}
    \input{chapters/6-Zusammenfassung.tex}
    \input{chapters/7-Danksagung.tex}
